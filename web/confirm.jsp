...
<head>
    ...
    <script type="text/javascript">
        ...
        function addAddr() {
            ...
            //***获取到输入的值,将值当作参数传给servlet处理
            var shipuname = document.getElementById("addName").value;
            var adres = document.getElementById("addAdd").value;
            var phone = document.getElementById("addPhone").value;
            var a =  document.getElementById("submitAdd");
            a.href = "SaveAddressServlet?shipuname="+shipuname+"&adres="+adres+"&phone="+phone+"";
        }
...
<div class="content">
    <div class="contentCenter">
        ...
        <form action="ConfirmOrderServlet" method="post" name="orderForm">
            <div class="centerTop">
                ...
                <p style="font-size: 15px;">
                    ...
                    <!--一个表单中如果有button,并且该button有点击事件,那么会默认将form表单提交,这时候需要给button指明type类型  -->
                    <button
                            type="button" onclick="document.getElementById('divDialog').style.display=''">添加收件人</button>
                </p>
            </div>
            <p class="singleP">
                    ...
                    <c:forEach items="${cart.orderlines}" var="lines">
                        <ul class="oneUL">
                            <li><img src="images/viewBook.png" class="pic">
                                <p>${lines.book.name }</p>
                                <p>
                                    <font>¥${lines.book.price }</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;×${lines.num }&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;有货
                                </p>
                                <p>
            ...
            <div class="money">
                <span><font>${cart.size }</font>件商品，总商品金额：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¥${cart.cost }</span>
                <span><img src="images/sureLogo_18.png" alt="">运费：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¥0.00</span>

                <span>应付总额：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¥${cart.cost }</span>
            </div>
            <div class="submit">
				<span>应付金额：<font>¥${cart.cost }</font><a href="javascript:void(0);" onclick="javascript:document.orderForm.submit();" ><img src="images/21_03.png"
                                                                                                                                            alt=""></a></span>
            </div>
        </form>
...
<div id="divDialog"
    ...
    <div class="pop">
        ...
        <div class="pop_con">
            ...
            <div class="btn_bar">
                <a href="" id="submitAdd" class="btn_red"
                   onclick="addAddr()">确认新增收货地址</a>
                <a href="shopCart.jsp"
